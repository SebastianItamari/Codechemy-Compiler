...
class LL1:
    def __init__(self, grammar):
        ...
        grammarLL1.add_production("Program", "λ")
        ...
        grammarLL1.add_production("Expression'", "🜁 Term")
        grammarLL1.add_production("Expression'", "🜄 Term")
        grammarLL1.add_production("Expression'", "λ")
        ...
        grammarLL1.add_production("Condition", "Expression Condition'")
        grammarLL1.add_production("Condition'", "🜎 Expression")
        grammarLL1.add_production("Condition'", "🜍 Expression")
        grammarLL1.add_production("Condition'", "🜕 Expression")
        grammarLL1.add_production("Condition'", "🜔 Expression")
        grammarLL1.add_production("Condition'", "🜗 Expression")
