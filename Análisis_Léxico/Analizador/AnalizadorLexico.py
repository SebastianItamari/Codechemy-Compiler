    ...
    def analizar(self,codigo_fuente):
        while codigo_fuente:
            ...
            if re.match(self.patron_alie, codigo_fuente):
                ...
                self.tokens.append(('constant', numero, self.linea))
                codigo_fuente = re.sub(self.patron_numero, '', codigo_fuente, count=1)
            elif re.match(self.patron_pcoma, codigo_fuente):
                pcoma = re.match(self.patron_pcoma, codigo_fuente).group()
                self.tokens.append((';', pcoma, self.linea))
                codigo_fuente = re.sub(self.patron_pcoma, '', codigo_fuente, count=1)
                ...
                self.tokens.append(('identifier', identificador, self.linea))
                ...
                self.tokens.append(('sl', saltoLinea, self.linea))
