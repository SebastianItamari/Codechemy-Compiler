...
class CodechemyIDE:
    ...
    def create_menu(self):
        ...
        symbol_menu.add_command(label="🝯 bool", accelerator="F9", command=lambda: self.insert_symbol("🝯"))
        symbol_menu.add_command(label="🝮 char", accelerator="Ctrl-D", command=lambda: self.insert_symbol("🝮"))
        #symbol_menu.add_command(label="♒︎ string", accelerator="Ctrl-E", command=lambda: self.insert_symbol("♒︎"))
        #symbol_menu.add_command(label="♈︎ double", accelerator="Ctrl-F", command=lambda: self.insert_symbol("♈︎"))
        #symbol_menu.add_command(label="♋︎ float", accelerator="Ctrl-G", command=lambda: self.insert_symbol("♋︎"))
        #symbol_menu.add_command(label="♊︎ array", accelerator="Ctrl-H", command=lambda: self.insert_symbol("♊︎"))
        symbol_menu.add_command(label="🜂 +", accelerator="Ctrl-E", command=lambda: self.insert_symbol("🜂"))
        symbol_menu.add_command(label="🜄 -", accelerator="Ctrl-F", command=lambda: self.insert_symbol("🜄"))
        symbol_menu.add_command(label="🜁 *", accelerator="Ctrl-G", command=lambda: self.insert_symbol("🜁"))
        symbol_menu.add_command(label="🜃 /", accelerator="Ctrl-H", command=lambda: self.insert_symbol("🜃"))
        symbol_menu.add_command(label="🜅 %", accelerator="Ctrl-I", command=lambda: self.insert_symbol("🜅"))
        ...
        symbol_menu.add_command(label="🝳 Declaracion", accelerator="Ctrl-X", command=lambda: self.insert_symbol("🝳"))
    ...
    def bind_events(self):
        ...
        self.window.bind("<Control-e>", lambda event: self.insert_symbol("🜂"))
        self.window.bind("<Control-F>", lambda event: self.insert_symbol("🜄"))
        self.window.bind("<Control-f>", lambda event: self.insert_symbol("🜄"))
        self.window.bind("<Control-G>", lambda event: self.insert_symbol("🜁"))
        self.window.bind("<Control-g>", lambda event: self.insert_symbol("🜁"))
        self.window.bind("<Control-H>", lambda event: self.insert_symbol("🜃"))
        self.window.bind("<Control-h>", lambda event: self.insert_symbol("🜃"))
        self.window.bind("<Control-I>", lambda event: self.insert_symbol("🜅"))
        self.window.bind("<Control-i>", lambda event: self.insert_symbol("🜅"))
        ...
        self.window.bind("<Control-w>", lambda event: self.insert_symbol("☽"))
        self.window.bind("<Control-X>", lambda event: self.insert_symbol("🝳"))
        self.window.bind("<Control-x>", lambda event: self.insert_symbol("🝳"))
        self.window.bind("<Control-Y>", lambda event: self.insert_symbol("🝑"))
        self.window.bind("<Control-y>", lambda event: self.insert_symbol("🝑"))
        self.window.bind("<Control-Z>", lambda event: self.insert_symbol("🜌"))
        self.window.bind("<Control-z>", lambda event: self.insert_symbol("🜌"))
